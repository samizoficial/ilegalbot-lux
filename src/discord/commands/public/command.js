...
const commands = [
    new SlashCommandBuilder().setName('marcaracao').setDescription('Marque uma ação para ser realizada no servidor')
        ...
        .setRequired(true))
        .addStringOption(option => option.setName('organizacao')
        .setDescription('Nome da organização')
        .setRequired(true))
        .addStringOption(option => option.setName('tipoacao')
        ...
        .setRequired(true))
        .addStringOption(option => option.setName('membros')
        .setDescription('Nomes e IDs dos membros')
        .setRequired(true))
        .addStringOption(option => option.setName('datahora')
